  ...
  return (
    <HomeSection>
      ...
      <div className="w-full h-full flex flex-col sm:flex-row sm:relative justify-center items-center rounded-full bg-black-50 py-10 xl:py-0  xl:px-16  ">
        ...
        >
          ...
          <p className="w-10/12 text-justify  xl:text-start font-bold text-white px-5 pb-5 xl:py-0 xl:pl-2 xl:pr-32 xl:text-[1.099rem]">
            ...
            and Doloremque mollitia aliquid, ea voluptatem hic dolore sed voluptatum
      ...
      <motion.article
        ...
        animate={articleInView ? { opacity: 1 } : { opacity: 0 }}
        transition={{ duration: 1, delay: 1 }}
        className="w-full h-full text-black mt-52 sm:m-5" 
      >
        <p className="w-10/12  text-justify font-bold  px-5  py-5 xl:pl-2 xl:pr-32  xl:text-xl">
        ...
        <nav>
          <ul className="w-10/12  text-justify text-base font-bold  px-5 pb-5 xl:pl-2 xl:pr-32  xl:text-xl list-item">
            <li>
              ...
              communication. I have also led advocacy projects as an Early
              Career Policy Ambassador with the Society for Neuroscience and
              have written about science policy through Duke University.
            </li>
            <li>
            ...
            <li>
              ...
              skills, such as by organizing the ComSciCon-Triangle 2021
              conference and speaking about science policy and communication at
              workshops and seminars.
            </li>
            <li>
              I engage in public outreach through community organizations. As an
              undergraduate at Carnegie Mellon University, I founded a chapter
              of Nu Rho Psi (the national neuroscience honor society) and led
              our chapter through 30+ annual hours of educational outreach in
              the community. For my leadership as the founding president of this
            ...
            <li>
              ...
              for which I edited, produced, and composed the theme music to
              engage listeners from 45+ countries.
            </li>
            <li>
